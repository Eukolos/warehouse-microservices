...
public class WaybillInvoiceTopicProperties {
    private String topicName;
    private int partitionCount;
    private short replicationFactor;
    private String retentionInMs;

    public WaybillInvoiceTopicProperties() {
    }
    public WaybillInvoiceTopicProperties(String topicName, int partitionCount, short replicationFactor, String retentionInMs) {
